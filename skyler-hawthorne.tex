...
Additional responsibilities included: building middle-layer REST APIs that query the backend for user-facing data; building front-end tooling with Python, which included a framework for managing various internal and external feeds which fed the update streams; writing integration tests and creating test environments with Docker.\\
