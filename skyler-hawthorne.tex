...
Also assisted in building front-end tooling with Python, which included a framework for managing various internal and external feeds which fed the backend database. Also included writing integration testing frameworks and creating test environments with Docker. Started as a part-time intern, and was hired full-time in May 2015. \\

Technologies used: HBase \sbull Kafka \sbull ElasticSearch \sbull Java \sbull Python \sbull Docker \sbull Puppet \sbull Ansible}}
}
