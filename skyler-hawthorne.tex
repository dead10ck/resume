...
Additional responsibilities included: building middle-layer REST APIs that query the backend for user-facing data; building front-end tooling with Python, which included a framework for managing various internal and external feeds which fed the update streams; writing integration testing frameworks and creating test environments with Docker.\\

Started as a part-time intern, and was hired full-time in May 2015. \\

Technologies used: Java \sbull HBase \sbull Kafka \sbull ElasticSearch \sbull ZooKeeper \sbull Python \sbull Docker \sbull Puppet \sbull Ansible}}
}
